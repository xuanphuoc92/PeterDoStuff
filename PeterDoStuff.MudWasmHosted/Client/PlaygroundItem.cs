...
namespace PeterDoStuff.MudWasmHosted.Client
{
    public class PlaygroundItem
    {
        ...
        public static readonly List<PlaygroundItem> Items = new List<PlaygroundItem>()
        {
            ...
            new(PlaygroundGroup.Demos, "workflow", Icons.Material.Filled.AccountTree, "Workflow", "This page demonstrates the workflow presentation in waterfall model."),
            ...
            new(PlaygroundGroup.Demos, "database", Icons.Material.Filled.Storage, "Database", "This page demonstrates memory database of the server."),
